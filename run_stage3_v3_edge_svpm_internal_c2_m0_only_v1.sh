...
REFINE_ROOT="$ROOT/Dataset/Stage3MaskRefine_SVPM_internal_C2_m0_only_v1"
GATE_ROOT="$ROOT/Dataset/Stage3AutoGate_SVPM_internal_C2_m0_only_v1"
...
EXP_NAME="stage3_v3_edge_svpm_internal_c2_m0_only_v1"
