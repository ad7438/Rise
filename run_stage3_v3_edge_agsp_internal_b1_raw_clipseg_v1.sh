...
REFINE_ROOT="$ROOT/Dataset/Stage3MaskRefine_AGSP_Internal_B1_raw_clipseg_v1"
GATE_ROOT="$ROOT/Dataset/Stage3AutoGate_AGSP_Internal_B1_raw_clipseg_v1"
...
EXP_NAME="stage3_v3_edge_agsp_internal_b1_raw_clipseg_v1"
...
$PYTHON -m stage3_mask_refine.pipeline_cli \
  ...
  --semantic_prior_mode raw_clipseg \
  --no-use_agsp \
  --anchor_radius 25 \
  --anchor_blur 7 \
  --mask_blur 5 \
  --lambda_s 0.2 \
  --visual_prior_mode grabcut \
  --refine_module old_dual_consistency \
  --save_agsp_vis \
