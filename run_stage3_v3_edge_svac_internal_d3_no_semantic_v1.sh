...
REFINE_ROOT="$ROOT/Dataset/Stage3MaskRefine_SVAC_Internal_D3_no_semantic_v1"
GATE_ROOT="$ROOT/Dataset/Stage3AutoGate_SVAC_Internal_D3_no_semantic_v1"
...
EXP_NAME="stage3_v3_edge_svac_internal_d3_no_semantic_v1"
