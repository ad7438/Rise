...
REFINE_ROOT="$ROOT/Dataset/Stage3MaskRefine_AGSP_SVPM_full_v1"
GATE_ROOT="$ROOT/Dataset/Stage3AutoGate_AGSP_SVPM_full_v1"
...
EXP_NAME="stage3_v3_edge_agsp_svpm_full_v1"
