...
REFINE_ROOT="$ROOT/Dataset/Stage3MaskRefine_AGSP_Internal_B2_no_mf0_v1"
GATE_ROOT="$ROOT/Dataset/Stage3AutoGate_AGSP_Internal_B2_no_mf0_v1"
...
EXP_NAME="stage3_v3_edge_agsp_internal_b2_no_mf0_v1"
...
$PYTHON -m stage3_mask_refine.pipeline_cli \
  ...
  --semantic_prior_mode agsp_no_mf0 \
  --use_agsp \
  --anchor_radius 25 \
  --anchor_blur 7 \
  --mask_blur 5 \
