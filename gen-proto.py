...
parser.add_argument("--cluster_path", type=str, default=os.path.join(WORKSPACE_ROOT, 'cluster_map'))
parser.add_argument("--save_path", type=str, default=os.path.join(WORKSPACE_ROOT, 'prototype'))
