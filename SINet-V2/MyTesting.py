...
TEST_DATASET_ROOT = os.path.join(PROJECT_ROOT, 'Dataset', 'TestDataset')
...
parser.add_argument('--data_path', type=str, default=TEST_DATASET_ROOT)
...
dataset_names = sorted(
    name for name in os.listdir(opt.data_path)
    if os.path.isdir(os.path.join(opt.data_path, name))
)
