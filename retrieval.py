...
parser.add_argument("--data_path", type=str, default=os.path.join(DATASET_ROOT, 'TrainDataset', 'Image'))
parser.add_argument("--prototype_path", type=str, default=os.path.join(WORKSPACE_ROOT, 'prototype'))
parser.add_argument("--save_path", type=str, default=os.path.join(WORKSPACE_ROOT, 'pseudo_mask'))
